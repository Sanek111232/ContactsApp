...
namespace ContactApp.UnitTests
{
    internal class ContactTest
    {
        ...
        {
            DateTime birthday = new DateTime(1999, 9, 9);
            _contact = new Contact("Меньшиков", "Александр", "a@mail.ru", "id777", birthday, new PhoneNumber(79999999999));
        }
