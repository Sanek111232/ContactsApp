...
namespace ContactApp.UnitTests
{
    internal class ProjectTest
    {
        ...
        public void TestContactsSet_CorrectString()
        {
            ...
            () => {
                List<Contact> contacts = new List<Contact>();
                contacts.Add(new Contact("Меньшиков", "Александр", "ma@mail.ru", "id654321", DateTime.Now, new PhoneNumber(78005553535)));
        ...
        {
            List<Contact> contacts = new List<Contact>();
            contacts.Add(new Contact("Меньшикова", "Виктория", "mv@mail.ru", "id654321", DateTime.Now, new PhoneNumber(78005553535)));
