...
namespace ContactsAppUI
{
    ...
    public partial class ContactsAppForm : Form
    {
        ...
        public ContactsAppForm()
        {
            ...
            {
                PhoneNumber phone = new PhoneNumber(78901234567);
                ContactsProject = new Project(new List<Contact>() { { new Contact("Меньшиков", "Александр", "m@mail.ru", "id777", DateTime.Now, phone) } });
            }
            else
            {
